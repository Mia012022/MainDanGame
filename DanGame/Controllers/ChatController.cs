    ...
    public class ChatController : Controller
    {
        ...
        public async Task<string> Chat([FromBody] ChatContent[] contents)
        {
            ...
            chatRequests.Messages = [
                ...
                ChatMessage.FromSystem("Q:如何創建帳戶？A:點擊網站右上角的頭像圖像按鈕，進到登入畫面點擊“註冊”，填寫必要的信息並完成註冊過程。註冊成功後，您將收到確認郵件。"),
                ChatMessage.FromSystem("Q:忘記密碼怎麼辦？A:點擊“忘記密碼”，輸入您的電子郵件地址，我們會發送一封重置密碼的郵件給您。"),
                ChatMessage.FromSystem("Q:如何更改帳戶訊息？A:登入帳戶後，前往“帳戶設置”頁面，您可以修改電子郵件地址、密碼和其他個人信息。"),
                ...
                ChatMessage.FromSystem("Q:我們的付款信息安全嗎？A:我們使用先進的加密技術來保護您的付款信息，確保交易的安全性。"),
            ];
